...
public final class SuccessdialogBinding implements ViewBinding {
  ...
  private SuccessdialogBinding(@NonNull ConstraintLayout rootView, @NonNull ConstraintLayout dialog,
  ...
  public static SuccessdialogBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.successdialog, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  public static SuccessdialogBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new SuccessdialogBinding((ConstraintLayout) rootView, dialog, doneTick,
